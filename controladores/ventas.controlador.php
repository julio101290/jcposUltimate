...
class ControladorVentas {
    ...
    static public function ctrCrearVenta() {
        ...
        if (isset($_POST["nuevaVenta"])) {
            ...
            foreach ($listaProductos as $key => $value) {
                ...
                $datosDetalle["idVenta"] = $datosVentaGuardada["id"];

                $datosDetalle["idProducto"] = $value["id"];
                $datosDetalle["descripcion"] = $value["descripcion"];
                $datosDetalle["cantidad"] = $value["cantidad"];
                $datosDetalle["precio"] = $value["precio"];
                $datosDetalle["importeTotal"] = $value["total"];
                
                $datosDetalle["descuento"] = $value["descuentoProducto"];
                $datosDetalle["idDescuento"] = $value["idDescuento"];
                $datosDetalle["porcDescuento"] = $value["porcDescuento"];
    ...
    static public function ctrEditarVenta() {
        ...
        if (isset($_POST["editarVenta"])) {
            ...
            if ($respuesta == "ok") {
                ...
                $eliminaDetalleVenta = modeloVentasDetalle::mdlEliminar($traerVenta["id"]);

                //GUARDAR EL DETALLE
                
                $productosDetalleGuardar = json_decode($listaProductos,true);

                foreach ($productosDetalleGuardar as $key => $value) {

                    $datosDetalle["idVenta"] = $datos["id"];
    ...
    static public function ctrEliminarVenta() {
        ...
        if (isset($_GET["idVenta"])) {
            ...
            $eliminar = modeloVentasDetalle::mdlEliminar($_GET["idVenta"]);
