  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-lg-7 col-xs-12">
               ...
               <div class="input-group date" data-provide="datepicker"  data-date-format="yyyy/mm/dd">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control select2 seleccionarCliente" id="seleccionarCliente" name="seleccionarCliente" required style="width: 100%;">
                          ...
                          <div class="col-xs-2" style="padding-right:0px">
                            ...
                            <div class="input-group">
                              ...
                              <button   class="btn btn-danger  quitarProducto" idProducto="'.$value["id"].'"><strong>X</strong></button>
                               <button type="button" class="btn btn-warning obtenerDescuento" data-toggle="modal" data-target="#modalDescuento" style="padding-right: 9px;padding-left: 9px;"><strong>%</strong></button>        
                            </div>
        ...
        <input type="hidden" class="form-control descuento"  name="descuento" value="' . $value["descuentoProducto"] . '" readonly required>
                             <input type="hidden" class="form-control idDescuento"  name="idDescuento" value="' . $value["idDescuento"] . '" readonly required>
                             <input type="hidden" class="form-control porcDescuento"  name="porcDescuento" value="' . $value["porcDescuento"] . '" readonly required>    
...
function onScanSuccess(decodedText, decodedResult) {
    if (decodedText !== lastResult) {
        ...
        $(".seleccionarCliente").val(lastResult);
