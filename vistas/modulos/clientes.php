...
<script>
    ...
    $(".tablaClientes").on("click", ".btnCodigoBarras", function () {


        var idCliente = $(this).attr("idCliente");
        console.log("Cliente: ", idCliente);

        window.open("extensiones/tcpdf/pdf/clienteCodigoBarras.php?idCliente=" + idCliente, "_blank");
     ...
     * Imprime Código QR
     */
    $(".tablaClientes").on("click", ".btnCodigoQR", function () {


        var idCliente = $(this).attr("idCliente");
        console.log("Cliente: ", idCliente);

        window.open("extensiones/tcpdf/pdf/clienteQR.php?idCliente=" + idCliente, "_blank");
