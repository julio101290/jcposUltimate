            ...
            <div class="box-body">
              ...
              <div class="box">
               ...
               <div class="input-group date" data-provide="datepicker" data-date-format="yyyy/mm/dd" required>
                ...
                $listaProducto = modeloVentasDetalle::mdlMostrar($venta["id"]);
                ...
                foreach ($listaProducto as $key => $value) {
                    ...
                    $value["total"] = $value["importeTotal"];
                          ...
                          <div class="col-xs-2 ingresoPrecio" style="padding-left:0px">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control nuevoPrecioProducto" precioReal="'.$respuesta["precio"].'" name="nuevoPrecioProducto" value="'.$value["total"].'" readonly required>
                                      <input type="hidden" class="form-control descuento"  name="descuento" value="' . $value["descuento"] . '" readonly required>
