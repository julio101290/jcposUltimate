                ...
                success: function (respuesta) {
                    ...
                    $(".nuevoProducto").append(
                            ...
                            '<input type="text" class="form-control nuevoPrecioProducto" readonly precioReal="' + precio + '" name="nuevoPrecioProducto" value="' + precio + '"  required>' +
                               ...
                               '<input type="hidden" class="form-control descuento" readonly  name="descuento" value="0"  required>' +
                                '<input type="hidden" class="form-control idDescuento" readonly  name="idDescuento" value="0"  required>' +
                                '<input type="hidden" class="form-control porcDescuento" readonly  name="porcDescuento" value="0"  required>' +
                            '</div>' +
                            '</div>' +
        ...
        success: function (respuesta) {
            ...
            $(".nuevoProducto").append(
                    ...
                    '           </div>' +
                     ...
                     '  <div class="col-xs-1" style="padding-right:0px">' +
                    '             <div class="input-group"> ' +
                    '<button type="button" class="btn btn-warning obtenerDescuento" data-toggle="modal" data-target="#modalDescuento" ><strong>%</strong></button>'+
                    '             </div>' +
                    '           </div>' +
...
function sumarTotalPrecios() {
    ...
    var sumaTotalDescuentoProducto = arraySumaDescuento.reduce(sumaArrayDescuento);
    
     if(sumaTotalDescuentoProducto>0){
        
        sumaTotalPrecio = sumaTotalPrecio - sumaTotalDescuentoProducto;
    }
...
function listarProductos() {
    ...
    var porcDescuento = $(".porcDescuento");
    
    var descuentoProducto = $(".descuento");
    ...
    for (var i = 0; i < descripcion.length; i++) {
        ...
        listaProductos.push({"id": $(descripcion[i]).attr("idProducto"),
            ...
            "porcDescuento": $(porcDescuento[i]).val(),
            "descuentoProducto": $(descuentoProducto[i]).val(),
            "idDescuento": $(idDescuento[i]).val(),
